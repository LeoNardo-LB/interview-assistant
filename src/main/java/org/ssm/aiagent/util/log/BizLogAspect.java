package org.ssm.aiagent.util.log;
...
import org.ssm.aiagent.util.log.handler.persistence.PersistenceHandler;
...
public class BizLogAspect {
    ...
    @Pointcut("@annotation(org.ssm.aiagent.util.log.BizLog)")
